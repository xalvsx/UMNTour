...
public class Corridor3left1 extends TourActivity {
    ...
    protected void setUpActivity() {
        ...
        if(isDay){
            ...
            details.put(btnToB304.getId(), "This is the way to go to the Corridor Example. Corridor Example links many other rooms.");
            ...
            details.put(btnToCorridor3left2.getId(), "This is the way to go to the Corridor Example. Corridor Example links many other rooms.");
            ...
            details.put(btnToCorridor3kiri2.getId(), "This is the way to go to the Corridor Example. Corridor Example links many other rooms.");
